...
class ProjectsController extends GetxController
  ...
  void addPortfolio() async {
    portfolios.add(MobilePortfolio(Portfolio(
      ...
      [
        "assets/images/kohmart_1.png",
        "assets/images/kohmart_2.png",
        "assets/images/kohmart_3.png",
        "assets/images/kohmart_4.png"
      ],
    ...
    portfolios.add(MobilePortfolio(Portfolio(
      ...
      [
        "assets/images/kargozare_man_1.png",
        "assets/images/kargozare_man_2.png",
        "assets/images/kargozare_man_3.png",
        "assets/images/kargozare_man_4.png"
      ],
    ...
    portfolios.add(WebPortfolio(Portfolio(
      ...
      [
        "assets/images/orthobiomed_1.png",
        "assets/images/orthobiomed_2.png",
        "assets/images/orthobiomed_3.png"
      ],
