...
import 'dropdown_src/dropdown_properties/dropdown_decorator_props.dart';
import 'dropdown_src/dropdown_properties/popup_props.dart';
import 'dropdown_src/dropdown_widgets/popup_menu.dart';
import 'dropdown_src/dropdown_widgets/selection_widget.dart';

export 'dropdown_src/dropdown_properties/bottom_sheet_props.dart';
export 'dropdown_src/dropdown_properties/clear_button_props.dart';
export 'dropdown_src/dropdown_properties/dialog_props.dart';
export 'dropdown_src/dropdown_properties/dropdown_button_props.dart';
export 'dropdown_src/dropdown_properties/dropdown_decorator_props.dart';
export 'dropdown_src/dropdown_properties/favorite_item_props.dart';
export 'dropdown_src/dropdown_properties/icon_button_props.dart';
export 'dropdown_src/dropdown_properties/list_view_props.dart';
export 'dropdown_src/dropdown_properties/menu_props.dart';
export 'dropdown_src/dropdown_properties/modal_bottom_sheet_props.dart';
export 'dropdown_src/dropdown_properties/popup_props.dart';
export 'dropdown_src/dropdown_properties/scrollbar_props.dart';
export 'dropdown_src/dropdown_properties/text_field_props.dart';
...
class DropdownSearchState<T> extends State<DropdownSearch<T>> {
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [
            mng_theme.primaryColor,
            mng_theme.secondaryColor,
            mng_theme.primaryColor,
          ],
  ...
  Widget _formField() {
    return Container(
        ...
        child: _formFieldMultiSelection());
  ...
  Future _openModalBottomSheet() {
    final sheetTheme = Theme.of(context).primaryColorLight;
    return showModalBottomSheet<T>(
      ...
      backgroundColor: mng_theme.secondaryColor,
