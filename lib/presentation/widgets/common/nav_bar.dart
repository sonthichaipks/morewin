...
class Navbar extends GetResponsiveView<HomeController> {
  ...
  Widget desktop() {
    return Obx(() => Container(
          ...
          color: controller.navBarSelectedIndex.value == 1
                ...
                child: Row(
                  ...
                  children: controller.items.map((item) {
                    return InkWell(
                      ...
                      child: item == 'Help'
                          ? RoundedButton("Help", Colors.white, Colors.white,
                              Colors.lightBlue, () {
                              ...
                              children: [
                                Text(
                                  ...
                                  style: Styles.navBarTextStyle.copyWith(
                                    ...
                                    color: Styles.navBarTextStyle.color
                                        ?.withOpacity(
                                      controller.navBarSelectedIndex.value ==
                                              controller.items.indexOf(item)
                                          ? 1.0
                                ...
                                if (item != 'Help')
                                  AnimatedContainer(
                                    ...
                                    height: 2,
                                    width: 20,
                                    color: controller.navBarSelectedIndex ==
                                            controller.items.indexOf(item)
                                        ? Colors.white
                                        : Colors.transparent,
                                  ),
