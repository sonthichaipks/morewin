...
class SocialMediaBarForMobile extends StatefulWidget {
  ...
  @override
  State<SocialMediaBarForMobile> createState() =>
      _SocialMediaBarForMobileState();
}
...
class _SocialMediaBarForMobileState extends State<SocialMediaBarForMobile> {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding:
          EdgeInsets.symmetric(vertical: showMenu ? 24 : 12, horizontal: 12),
      margin: const EdgeInsets.only(bottom: 16, right: 16),
      decoration: BoxDecoration(
        border:
            Border.all(color: Colors.lightBlue.withOpacity(0.3), width: 1.4),
              ...
              : Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      onTap: () {
                        UrlHelper.launchUrl(
                          "mailto:pks.sonthichai@gmail.com?subject=Hello%20Milad",
                        );
                      },
                      child: Icon(
                        Icons.mail_outline,
                    ...
                    InkWell(
                      ...
                      onTap: () {
                        UrlHelper.launchUrl(
                            'https://stackoverflow.com/users/8349963');
                      },
                      child: Icon(
                    ...
                    InkWell(
                      ...
                      onTap: () {
                        UrlHelper.launchUrl(
                            'https://www.instagram.com/miladjalali.ir/');
                      },
                      child: Icon(
